...
The dated Windows and Linux builds, loaded-binding tests, and sanitized portable-harness results are recorded in [`docs/hardware-free-verification-2026-07-19.md`](../../docs/hardware-free-verification-2026-07-19.md).
